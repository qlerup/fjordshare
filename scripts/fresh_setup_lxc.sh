...
load_env_with_defaults() {
  ...
  : "${THUMB_DEFER_MAX_SECONDS:=43200}"
  : "${THUMB_MESH_RENDER_MAX_BYTES:=536870912}"
...
TUS_TMP_DIR=${TUS_TMP_DIR}
THUMBS_HOST_DIR=${THUMBS_HOST_DIR}
TZ=${TZ}
THUMB_SIZE_PX=${THUMB_SIZE_PX}
THUMB_WORKER_COUNT=${THUMB_WORKER_COUNT}
THUMB_DEFER_MAX_SECONDS=${THUMB_DEFER_MAX_SECONDS}
THUMB_MESH_RENDER_MAX_BYTES=${THUMB_MESH_RENDER_MAX_BYTES}
